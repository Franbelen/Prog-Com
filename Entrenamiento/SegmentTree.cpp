...
int n,a,b,x,c,q;
int qs, qe; // Starting and ending indexes of query range
...
/* A recursive function to get the minimum value in a given range of array indexes. The following 
...
{ 
    ...
    // If a part of this segmen overlaps with the given range 
...
{ 
    ...
    int arr[n+1]; 
    for(int i = 0; i < n; i++){cin >> a; arr[i] = a;}
